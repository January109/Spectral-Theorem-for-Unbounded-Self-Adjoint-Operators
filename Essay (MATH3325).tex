...
\end{definition}
Since each $E_{x, x}$ is a finite measure on $\R$, the spectral resolution determines the spectral measure $E$. Using the spectral resolution, we obtain the following description of the spectrum and eigenvalues of $T$.
...
[2] \textsc{W. Rudin}, (1991), \emph{Functional Analysis}, McGraw-Hill, New Jersey.
\end{document}